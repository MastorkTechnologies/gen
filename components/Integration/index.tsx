        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              ...
              subtitle: `Empower Your Team's Potential Elevate with Corporate Training`,
              description: `Elevate your workforce with our dynamic corporate training programs. Unleash untapped potential, foster innovation, and cultivate a culture of excellence. Empower your employees to thrive in an ever-evolving landscape, driving success at every turn.`,
            }}
          />
